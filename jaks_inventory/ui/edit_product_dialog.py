...
class _PAILookupWorker(QThread):
    ...
    def _result_to_dict(self, r, reasoning: str = "") -> dict:
        ...
        return {
            ...
            "alternate_sku": getattr(r, "alternate_sku", ""),
            "alternate_description": getattr(r, "alternate_description", ""),
            "alternate_your_price": getattr(r, "alternate_your_price", 0.0),
            "alternate_in_stock": getattr(r, "alternate_in_stock", False),
            "alternate_url": getattr(r, "alternate_url", ""),
