...
(The legacy GET /search header-dropdown endpoint and its
search/_results_dropdown.html partial were removed — no template referenced
them after the Ctrl+K overlay migration.)
"""
