...
class NewSODialog(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        # ESN / Part Finder side panel removed in the 2025 redesign —
        # ESN/VIN lookup now lives inline on the quote screen and the SO
        # dialog inherits the parts that were ported there. Widgets are
        # still constructed (off-screen) so legacy action methods keep
        # working.
    ...
    def _build_action_bar(self) -> QFrame:
        ...
        # code that still references `_toggle_finder_btn` keeps working.
